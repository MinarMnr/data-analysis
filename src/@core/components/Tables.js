        ...
        <Table responsive className="table-centered table-nowrap rounded mb-0">
          <thead className="thead-light">
            <tr>
              ...
              <th className="border-0">উৎসের ধরন </th>
              <th className="border-0">শ্রেণী</th>
              <th className="border-0"> বিশ্বব্যাংক</th>
              <th className="border-0">ট্রাফিক শেয়ার</th>
              <th className="border-0">পরিবর্তন Change</th>
            </tr>
          </thead>
          <tbody>
            {pageTraffic.map((pt) => (
      ...
      <tr>
        ...
        <td>
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Menu>
              <Dropdown.Item>
                <FontAwesomeIcon icon={faEye} className="me-2" /> বিস্তারিত
                দেখুন
              </Dropdown.Item>
              <Dropdown.Item>
          ...
          <Table hover className="user-table align-items-center">
            <thead>
              <tr>
                ...
                <th className="border-bottom">অবস্থা</th>
                <th className="border-bottom">প্রক্রিয়া</th>
              </tr>
            </thead>
            <tbody>
              {transactions.map((t) => (
        ...
        <Card.Footer className="px-3 border-0 d-lg-flex align-items-center justify-content-between">
          <Nav>
            <Pagination className="mb-2 mb-lg-0">
              ...
              <Pagination.Next>পরবর্তী</Pagination.Next>
            </Pagination>
          </Nav>
