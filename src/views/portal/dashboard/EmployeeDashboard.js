...
import {
    faAward, faBuilding, faCertificate, faExchangeAlt, faFile, faFileAlt, faFileDownload, faGraduationCap, faHeadSideCough, faLanguage, faLaptopCode,
    faUserAltSlash,
    faUserCheck, faUserEdit, faUserMinus,
    faUserPlus
                ...
                <div
                    ...
                    >
                        <Link >
                            ...
                            >
                                <Card.Body className="info-box-block">
                                    <Card.Title className="float-start m-0">এম পি ও (M.P.O)</Card.Title>
