...
const RegisterForm = ({
  ...
  if (ntrcaData.data !== undefined && ntrcaData.data.length > 0) {
    ...
    setFieldValue(
      "dateOfBirth",
      moment(ntrcaData.data[0].dob).format("YYYY-MM-DD") ?? ""
    );
  ...
  const handleEmployeeTypeChange = (event) => {
    if (event?.target?.value === "TEACHING_EMPLOYEE") {
      setFieldValue("jobRecommendationType", "NTRCA");
    } else if (event?.target?.value === "NON_TEACHING_EMPLOYEE") {
      setFieldValue("jobRecommendationType", "GB_SMC");
    }
    if (event.target.value != 0) {
  ...
  const handleNTRCAChange = (event) => {
    if (event.target.value != 0) {
      ...
      setFieldValue("ntrcaExamRollNumber", "");
      setFieldValue("ntrcaExamYear", "");
      if (event.target.value == "NTRCA") {
        setFieldValue("isNtrca", true);
      } else {
        setFieldValue("isNtrca", false);
      }
    }
  };
  ...
  useEffect(() => {
    dispatch(
      callApi({
        operationId: UrlBuilder.mpoDsheApi(`employee/institute-type/list`),
        ...
        >
          <Grid item xs={12} md={6} lg={3}>
            <ThemeForm.Group className="mb-3">
              ...
              <ThemeForm.Select
                ...
                id="isIndex"
                className="p-9"
                aria-label="ইনডেক্স নাম্বার"
                value={isIndex}
                onChange={handleIsIndexChange}
              >
                <option value="0">ইনডেক্স নাম্বার</option>
          ...
          <Grid item xs={12} md={6} lg={3}>
            <ThemeForm.Group className="mb-3">
              ...
              >
                <option value="0">পেশার ধরন</option>
                {/* <option value={EmployeeTypeStatus.TEACHING_EMPLOYEE}>
                  শিক্ষক
                </option> */}
                <option value={EmployeeTypeStatus.NON_TEACHING_EMPLOYEE}>
                  কর্মচারী
                </option>
              </ThemeForm.Select>
            </ThemeForm.Group>
            ...
            <>
              <Grid item xs={12} md={6} lg={3}>
                <ThemeForm.Group className="mb-3">
                  ...
                  >
                    <option value="0">নিয়োগ সুপারিশকারী</option>
                    <option value={JobRecommendationType.GB_SMC}>
                      নিয়োগ বোর্ড(জিবি/এসএমসি)
                    </option>

                    {/* {values.employeeTypeStatus === "TEACHING_EMPLOYEE" ? (
                      <option value={JobRecommendationType.NTRCA}>
                        এনটিআরসিএ
                      </option>
                    ) : (
                      <>
              ...
              {values.jobRecommendationType === JobRecommendationType.NTRCA && (
                <>
                  ...
                  >
                    <Button
                      onClick={handleNTRCAData}
                      title="তথ্য খুঁজুন"
                      variant="white"
                      disabled={
                        values.ntrcaExamYear && values.ntrcaExamRollNumber
                          ? false
                          : true
                      }
                      className="btn-theme"
          ...
          <Box>
            ...
            >
              ...
              <Grid item xs={12} md={2}>
                <Button variant="contained" className="btn-theme ">
                  তথ্য খুঁজুন{" "}
                  <FontAwesomeIcon className="pl-5" icon={faSearch} size="xl" />
                </Button>
              </Grid>
            </Grid>
            ...
            >
              ...
              <Grid item xs={12} md={4}>
                ...
                /> */}
                <label>
                  জন্মতারিখ<span className="text-danger">*</span>{" "}
                </label>
                <InputDatePicker
                  name={`dateOfBirth`}
            ...
            >
              <Grid item xs={12} md={4}>
                <label className="mb-10">বর্তমান পদবি</label>
                <InputSelect
                  name="designation"
                  type="number"
                  value="id"
          ...
          <Box>
            ...
            <Row className="p-20 pb-4 gx-6 gy-2">
              <Col xs={12} md={12} className="mb-10">
                <h4 className="text-start">সাধারণ তথ্য</h4>
              ...
              <Col xs={12} md={6} className="mb-10">
                <InputSelectApi
                  label="ধর্ম"
                  name="religion"
                  operationId={UrlBuilder.mpoDsheApi("employee/religion/all")}
              ...
              <Col xs={12} md={6} className="mb-10">
                <InputSelectApi
                  label="নিজ জেলা"
                  name="homeDistrict"
                  operationId={UrlBuilder.mpoDsheApi("employee/district/all")}
                ...
                <Row className="p-20 pb-4 gx-6 gy-2">
                  ...
                  <Col xs={12} md={6} className="mb-10">
                    <InputSelect
                      ...
                      value="id"
                      data={[
                        { id: EmploymentType.PERMANENT, name: "পূর্ণকালীন" },
                        { id: EmploymentType.PARTTIME, name: "খণ্ডকালীন" },
                      ]}
                      required={true}
                      text="name"
                    />
                  ...
                  <Col xs={12} md={6} className="mb-10">
                    ...
                    <InputDatePicker
                      name={`activeInstituteDateOfJoining`}
                      setField={setFieldValue}
                      dataValue={values?.activeInstituteDateOfJoining}
                    />
            ...
            <Row className="p-20 pb-4 gx-6 gy-2">
              ...
              <Col xs={12} md={6} className="mb-10">
                ...
                <input
                  ...
                  className={`form-control ${
                    props.touched.employeeImage && props.errors.employeeImage
                      ? "is-invalid"
                      : ""
                  }`}
                  onChange={(event) => {
              ...
              <Col xs={12} md={6} className="mb-10">
                ...
                <input
                  ...
                  type="file"
                  className={`form-control ${
                    props.touched.employeeAppoinment &&
